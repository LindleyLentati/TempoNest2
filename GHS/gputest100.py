...
lfunc = Likelihood()
lfunc.loadPulsar("OneChan.par", "OneChan.tim", root='./results/GHS-1Chan-')
...
lfunc.getInitialParams(MaxCoeff = 20, cov_diag=[0.01, 0.1, 0.1], resume=True, outDir = './InitFFTMNChains/1Chan-Max20-', sampler='multinest', incScattering = False, mn_live = 1000,  fitNComps = 1, doplot = False)
